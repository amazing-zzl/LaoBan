...
public class AddressToLatitudeLongitude {
    ...
    public void getLatAndLngByAddress() {
        ...
        String url = String.format("http://api.map.baidu.com/geocoder/v2/?"
                + "&mcode=72:2B:6A:60:DC:44:F0:0F:2A:89:12:2A:53:5B:4E:C5:85:DC:B9:2B;com.example.zzl.LaoBan.Activity&"
                + "address=%s&ak=FPXh87lxdQ1CNGZwn4eQx38hn2jLSA0F&output=json", addr);
        URL myURL = null;
